...
import { CreateOAuthClientCommand } from './create-oauth-client.command';

@Injectable()
export class CreateOAuthClientHandler
  implements
    CommandHandler<CreateOAuthClientCommand, Result<OAuthClientEntity, OAuthClientCreationError>>
{
  constructor(
